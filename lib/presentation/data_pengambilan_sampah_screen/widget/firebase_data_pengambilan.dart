...
class FirebaseDataPengambilan extends StatelessWidget {
  final DatabaseReference databaseReference = FirebaseDatabase.instance.ref();
  final String selectedNode;

  FirebaseDataPengambilan({required this.selectedNode});
        ...
        if (snapshot.connectionState == ConnectionState.done) {
          if (snapshot.hasData) {
            ...
            if (testData != null) {
              ...
              List<String> nodesToRetrieve = ["Reset"];
                      ...
                      dataWidgets.add(
                        ListTile(
                          title: Row(
                            ...
                            children: <Widget>[
                              Text('# ', textAlign: TextAlign.left, style: CustomTextStyles.titleLargeBackground),
